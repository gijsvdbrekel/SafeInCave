// ============================================================================
// MULTI-CHAMBER CAVERN - SCALED TO 1.2 MILLION m³
// ============================================================================
// Original volume: ~0.601 Mm³
// Target volume:   1.2 Mm³
// Scale factor:    1.259407
// 
// All geometric variables scaled: h_bottom, H1, H2, R1, R2, R3
// Point expressions will be evaluated with scaled variables
...
h_bottom = 194.833113;  // was 154.702263, scaled by 1.259407 for 1.2M m³
H1 = 66.466868;  // was 52.776321, scaled by 1.259407 for 1.2M m³
H2 = 66.466868;  // was 52.776321, scaled by 1.259407 for 1.2M m³
R1 = 45.577281;  // was 36.189477, scaled by 1.259407 for 1.2M m³
R2 = 39.880121;  // was 31.665793, scaled by 1.259407 for 1.2M m³
R3 = 47.476334;  // was 37.697372, scaled by 1.259407 for 1.2M m³
