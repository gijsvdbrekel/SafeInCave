// ============================================================================
// REGULAR CAVERN - SCALED TO 1.2 MILLION m³
// ============================================================================
// Original volume: ~0.6 Mm³
// Target volume:   1.2 Mm³
// Scale factor:    1.247283
// 
...
// SCALED to 620k m³ volume (reduced from 752k)
...
// Geometry parameters (SCALED by 0.937772 for 620k m³)
h_bottom = 194.951186;  // was 156.300684, scaled by 1.247283 for 1.2M m³
H_cavern = 102.270532;  // was 81.994649, scaled by 1.247283 for 1.2M m³
R = 47.996425;  // was 38.480782, scaled by 1.247283 for 1.2M m³
