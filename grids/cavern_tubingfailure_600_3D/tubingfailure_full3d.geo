...
// Target volume:   0.6 Mm³
// Scale factor from 1200k: 0.793701
//
// Compared to multichamber: R2 significantly smaller = more pronounced neck
...
// Geometry parameters (SCALED from 1200k by 0.793701)
h_bottom = 239.098322;
H1 = 51.032521;
H2 = 51.032521;
R1 = 38.274391;  // bottom chamber radius
R2 = 23.921494;  // middle chamber radius - smaller = pronounced neck
R3 = 41.463923;  // top chamber radius
