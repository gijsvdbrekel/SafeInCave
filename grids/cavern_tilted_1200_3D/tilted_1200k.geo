// ============================================================================
// TILTED CAVERN - SCALED TO 1.2 MILLION m³
// ============================================================================
// Original volume: ~0.6 Mm³
// Target volume:   1.2 Mm³
// Scale factor:    1.246225
// 
...
h_bottom = 181.490674;  // was 145.632349, scaled by 1.246225 for 1.2M m³
H_cavern = 166.136375;  // was 133.311701, scaled by 1.246225 for 1.2M m³
R = 41.576934;  // was 33.362301, scaled by 1.246225 for 1.2M m³

// Tilt parameters
tilt_angle = 7.076064;  // was 5.677999, scaled by 1.246225 for 1.2M m³
