// Regular Cavern - SCALED to 0.6M m³ volume
// Scaling factor: 0.699728 (from original)
...
h = 205.189718;
H = 81.144468;  // was 115.966 (original), now scaled to 600k m³
R = 38.080682;  // was 54.422 (original), now scaled to 600k m³
