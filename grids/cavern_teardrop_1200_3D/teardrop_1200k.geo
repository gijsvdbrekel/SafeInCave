// ============================================================================
// TEARDROP CAVERN - SCALED TO 1.2 MILLION m³
// ============================================================================
// Original volume: ~0.6 Mm³
// Target volume:   1.2 Mm³
// Scale factor:    1.260259
// 
...
//////////////////////////////////////////////////////////////
// TEARDROP CAVERN - FULL 3D (No Symmetry)
// SCALED to 1.4M m³ volume
// Wide top tapering to narrow pointed bottom
...
h_bottom = 209.037191;  // was 165.868437, scaled by 1.260259 for 1.2M m³
H_cavern = 167.894871;  // was 133.222513, scaled by 1.260259 for 1.2M m³
Rt = 60.620786;  // was 48.101847, scaled by 1.260259 for 1.2M m³
Rb = 7.506336;  // was 5.956185, scaled by 1.260259 for 1.2M m³
...
//////////////////////////////
// CAVERN GEOMETRY - BOTTOM TIP (SMALL)
//////////////////////////////

Point(100) = {x_center, y_center, h_bottom, size_fine};                    // bottom tip
Point(101) = {x_center, y_center, h_bottom+Rb, size_coarse};              // bottom center

Point(102) = {x_center+Rb, y_center, h_bottom+Rb, size_fine};             // +x (small)
Point(103) = {x_center-Rb, y_center, h_bottom+Rb, size_fine};             // -x (small)
Point(104) = {x_center, y_center+Rb, h_bottom+Rb, size_fine};             // +y (small)
Point(105) = {x_center, y_center-Rb, h_bottom+Rb, size_fine};             // -y (small)

//////////////////////////////
// CAVERN GEOMETRY - TOP BULB (LARGE)
//////////////////////////////

Point(110) = {x_center, y_center, h_bottom+Rb+H_cavern+Rt, size_fine};    // top tip
Point(111) = {x_center, y_center, h_bottom+Rb+H_cavern, size_coarse};     // top center

Point(112) = {x_center+Rt, y_center, h_bottom+Rb+H_cavern, size_fine};    // +x (large)
Point(113) = {x_center-Rt, y_center, h_bottom+Rb+H_cavern, size_fine};    // -x (large)
Point(114) = {x_center, y_center+Rt, h_bottom+Rb+H_cavern, size_fine};    // +y (large)
Point(115) = {x_center, y_center-Rt, h_bottom+Rb+H_cavern, size_fine};    // -y (large)
...
//////////////////////////////
// CAVERN CONNECTION LINES (TAPERED)
//////////////////////////////

Line(20) = {102, 112};  // +x side (tapered from small to large)
Line(21) = {103, 113};  // -x side
Line(22) = {104, 114};  // +y side
Line(23) = {105, 115};  // -y side

//////////////////////////////
// CIRCLE ARCS - BOTTOM TIP (SMALL)
//////////////////////////////
...
// Tapered side wall surfaces (connecting small bottom to large top)
