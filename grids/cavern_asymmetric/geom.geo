...
H  = 150.3;            // height between chambers (was 160.0)
Rx_bottom = 56.4;      // bottom radius in x (was 60.0)
Ry_bottom = 37.6;      // bottom radius in y (was 40.0)
Rx_top = 37.6;         // top radius in x (was 40.0)
Ry_top = 56.4;         // top radius in y (was 60.0)
