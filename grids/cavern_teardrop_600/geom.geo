...
// Geometry parameters (SCALED by 0.738395)
h  = 220.0;            // bottom of cavern (slightly higher)
H = 132.920064;  // was 180.000 (original), now scaled to 600k m³
Rt = 47.992643;  // was 65.000 (original), now scaled to 600k m³
Rb = 5.942663;  // was 8.000 (original), now scaled to 600k m³
