...
// Geometry parameters (SCALED by 0.706503)
h  = 205.189718;       // bottom of cavern
H1 = 56.493154;  // was 80.000 (original), now scaled to 600k m³
H2 = 56.493154;  // was 80.000 (original), now scaled to 600k m³
Rb = 38.890760;  // was 55.000 (original), now scaled to 600k m³
Rm = 17.677618;  // was 25.000 (original), now scaled to 600k m³
Rt = 42.426283;  // was 60.000 (original), now scaled to 600k m³
