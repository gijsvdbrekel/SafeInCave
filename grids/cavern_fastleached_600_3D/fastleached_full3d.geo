...
// Level 1 - bottom tip (z=209.81)
Point(100) = {225.000000, 225.000000, 209.807631, size_fine};  // tip
Point(101) = {225.000000, 225.000000, 213.045799, size_coarse};  // center
Point(102) = {232.123970, 225.000000, 213.045799, size_fine};  // +x
Point(103) = {217.876030, 225.000000, 213.045799, size_fine};  // -x
Point(104) = {225.000000, 232.123970, 213.045799, size_fine};  // +y
Point(105) = {225.000000, 217.876030, 213.045799, size_fine};  // -y

// Level 2 (z=216.28, R=17.81)
Point(110) = {225.000000, 225.000000, 216.283967, size_coarse};  // center
Point(112) = {242.809924, 225.000000, 216.283967, size_fine};  // +x
Point(113) = {207.190076, 225.000000, 216.283967, size_fine};  // -x
Point(114) = {225.000000, 242.809924, 216.283967, size_fine};  // +y
Point(115) = {225.000000, 207.190076, 216.283967, size_fine};  // -y

// Level 3 (z=232.47, R=42.10)
Point(120) = {225.000000, 225.000000, 232.474807, size_coarse};  // center
Point(122) = {267.096185, 225.000000, 232.474807, size_fine};  // +x
Point(123) = {182.903815, 225.000000, 232.474807, size_fine};  // -x
Point(124) = {225.000000, 267.096185, 232.474807, size_fine};  // +y
Point(125) = {225.000000, 182.903815, 232.474807, size_fine};  // -y

// Level 4 (z=248.67, R=29.14)
Point(130) = {225.000000, 225.000000, 248.665647, size_coarse};  // center
Point(132) = {254.143513, 225.000000, 248.665647, size_fine};  // +x
Point(133) = {195.856487, 225.000000, 248.665647, size_fine};  // -x
Point(134) = {225.000000, 254.143513, 248.665647, size_fine};  // +y
Point(135) = {225.000000, 195.856487, 248.665647, size_fine};  // -y

// Level 5 (z=264.86, R=45.33)
Point(140) = {225.000000, 225.000000, 264.856487, size_coarse};  // center
Point(142) = {270.334353, 225.000000, 264.856487, size_fine};  // +x
Point(143) = {179.665647, 225.000000, 264.856487, size_fine};  // -x
Point(144) = {225.000000, 270.334353, 264.856487, size_fine};  // +y
Point(145) = {225.000000, 179.665647, 264.856487, size_fine};  // -y

// Level 6 (z=281.05, R=30.76)
Point(150) = {225.000000, 225.000000, 281.047328, size_coarse};  // center
Point(152) = {255.762597, 225.000000, 281.047328, size_fine};  // +x
Point(153) = {194.237403, 225.000000, 281.047328, size_fine};  // -x
Point(154) = {225.000000, 255.762597, 281.047328, size_fine};  // +y
Point(155) = {225.000000, 194.237403, 281.047328, size_fine};  // -y

// Level 7 (z=297.24, R=43.72)
Point(160) = {225.000000, 225.000000, 297.238168, size_coarse};  // center
Point(162) = {268.715269, 225.000000, 297.238168, size_fine};  // +x
Point(163) = {181.284731, 225.000000, 297.238168, size_fine};  // -x
Point(164) = {225.000000, 268.715269, 297.238168, size_fine};  // +y
Point(165) = {225.000000, 181.284731, 297.238168, size_fine};  // -y

// Level 8 (z=313.43, R=32.38)
Point(170) = {225.000000, 225.000000, 313.429008, size_coarse};  // center
Point(172) = {257.381681, 225.000000, 313.429008, size_fine};  // +x
Point(173) = {192.618319, 225.000000, 313.429008, size_fine};  // -x
Point(174) = {225.000000, 257.381681, 313.429008, size_fine};  // +y
Point(175) = {225.000000, 192.618319, 313.429008, size_fine};  // -y

// Level 9 (z=329.62, R=40.48)
Point(180) = {225.000000, 225.000000, 329.619849, size_coarse};  // center
Point(182) = {265.477101, 225.000000, 329.619849, size_fine};  // +x
Point(183) = {184.522899, 225.000000, 329.619849, size_fine};  // -x
Point(184) = {225.000000, 265.477101, 329.619849, size_fine};  // +y
Point(185) = {225.000000, 184.522899, 329.619849, size_fine};  // -y

// Level 10 (z=345.81, R=27.52)
Point(190) = {225.000000, 225.000000, 345.810689, size_coarse};  // center
Point(192) = {252.524428, 225.000000, 345.810689, size_fine};  // +x
Point(193) = {197.475572, 225.000000, 345.810689, size_fine};  // -x
Point(194) = {225.000000, 252.524428, 345.810689, size_fine};  // +y
Point(195) = {225.000000, 197.475572, 345.810689, size_fine};  // -y

// Level 11 (z=359.57, R=37.24)
Point(200) = {225.000000, 225.000000, 359.572903, size_coarse};  // center
Point(202) = {262.238933, 225.000000, 359.572903, size_fine};  // +x
Point(203) = {187.761067, 225.000000, 359.572903, size_fine};  // -x
Point(204) = {225.000000, 262.238933, 359.572903, size_fine};  // +y
Point(205) = {225.000000, 187.761067, 359.572903, size_fine};  // -y

// Level 12 (z=370.10, R=8.10)
Point(210) = {225.000000, 225.000000, 370.096949, size_coarse};  // center
Point(212) = {233.095420, 225.000000, 370.096949, size_fine};  // +x
Point(213) = {216.904580, 225.000000, 370.096949, size_fine};  // -x
Point(214) = {225.000000, 233.095420, 370.096949, size_fine};  // +y
Point(215) = {225.000000, 216.904580, 370.096949, size_fine};  // -y

// Level 13 - top tip (z=378.19)
Point(220) = {225.000000, 225.000000, 378.192369, size_fine};  // tip
Point(221) = {225.000000, 225.000000, 374.144659, size_coarse};  // center
Point(222) = {228.238168, 225.000000, 374.144659, size_fine};  // +x
Point(223) = {221.761832, 225.000000, 374.144659, size_fine};  // -x
Point(224) = {225.000000, 228.238168, 374.144659, size_fine};  // +y
Point(225) = {225.000000, 221.761832, 374.144659, size_fine};  // -y
