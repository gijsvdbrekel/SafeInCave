...
// Level 1 - bottom tip (z=212.25)
Point(100) = {225.000000, 225.000000, 212.249403, size_fine};  // tip
Point(101) = {225.000000, 225.000000, 215.393657, size_coarse};  // center
Point(102) = {231.917358, 225.000000, 215.393657, size_fine};  // +x
Point(103) = {218.082642, 225.000000, 215.393657, size_fine};  // -x
Point(104) = {225.000000, 231.917358, 215.393657, size_fine};  // +y
Point(105) = {225.000000, 218.082642, 215.393657, size_fine};  // -y

// Level 2 (z=218.54, R=17.29)
Point(110) = {225.000000, 225.000000, 218.537911, size_coarse};  // center
Point(112) = {242.293395, 225.000000, 218.537911, size_fine};  // +x
Point(113) = {207.706605, 225.000000, 218.537911, size_fine};  // -x
Point(114) = {225.000000, 242.293395, 218.537911, size_fine};  // +y
Point(115) = {225.000000, 207.706605, 218.537911, size_fine};  // -y

// Level 3 (z=226.40, R=29.87)
Point(120) = {225.000000, 225.000000, 226.398545, size_coarse};  // center
Point(122) = {254.870410, 225.000000, 226.398545, size_fine};  // +x
Point(123) = {195.129590, 225.000000, 226.398545, size_fine};  // -x
Point(124) = {225.000000, 254.870410, 226.398545, size_fine};  // +y
Point(125) = {225.000000, 195.129590, 226.398545, size_fine};  // -y

// Level 4 (z=234.26, R=40.88)
Point(130) = {225.000000, 225.000000, 234.259179, size_coarse};  // center
Point(132) = {265.875298, 225.000000, 234.259179, size_fine};  // +x
Point(133) = {184.124702, 225.000000, 234.259179, size_fine};  // -x
Point(134) = {225.000000, 265.875298, 234.259179, size_fine};  // +y
Point(135) = {225.000000, 184.124702, 234.259179, size_fine};  // -y

// Level 5 (z=242.12, R=37.73)
Point(140) = {225.000000, 225.000000, 242.119814, size_coarse};  // center
Point(142) = {262.731045, 225.000000, 242.119814, size_fine};  // +x
Point(143) = {187.268955, 225.000000, 242.119814, size_fine};  // -x
Point(144) = {225.000000, 262.731045, 242.119814, size_fine};  // +y
Point(145) = {225.000000, 187.268955, 242.119814, size_fine};  // -y

// Level 6 (z=249.98, R=31.44)
Point(150) = {225.000000, 225.000000, 249.980448, size_coarse};  // center
Point(152) = {256.442537, 225.000000, 249.980448, size_fine};  // +x
Point(153) = {193.557463, 225.000000, 249.980448, size_fine};  // -x
Point(154) = {225.000000, 256.442537, 249.980448, size_fine};  // +y
Point(155) = {225.000000, 193.557463, 249.980448, size_fine};  // -y

// Level 7 (z=257.84, R=38.52)
Point(160) = {225.000000, 225.000000, 257.841082, size_coarse};  // center
Point(162) = {263.517108, 225.000000, 257.841082, size_fine};  // +x
Point(163) = {186.482892, 225.000000, 257.841082, size_fine};  // -x
Point(164) = {225.000000, 263.517108, 257.841082, size_fine};  // +y
Point(165) = {225.000000, 186.482892, 257.841082, size_fine};  // -y

// Level 8 (z=265.70, R=43.23)
Point(170) = {225.000000, 225.000000, 265.701717, size_coarse};  // center
Point(172) = {268.233489, 225.000000, 265.701717, size_fine};  // +x
Point(173) = {181.766511, 225.000000, 265.701717, size_fine};  // -x
Point(174) = {225.000000, 268.233489, 265.701717, size_fine};  // +y
Point(175) = {225.000000, 181.766511, 265.701717, size_fine};  // -y

// Level 9 (z=273.56, R=39.30)
Point(180) = {225.000000, 225.000000, 273.562351, size_coarse};  // center
Point(182) = {264.303171, 225.000000, 273.562351, size_fine};  // +x
Point(183) = {185.696829, 225.000000, 273.562351, size_fine};  // -x
Point(184) = {225.000000, 264.303171, 273.562351, size_fine};  // +y
Point(185) = {225.000000, 185.696829, 273.562351, size_fine};  // -y

// Level 10 (z=281.42, R=33.01)
Point(190) = {225.000000, 225.000000, 281.422985, size_coarse};  // center
Point(192) = {258.014664, 225.000000, 281.422985, size_fine};  // +x
Point(193) = {191.985336, 225.000000, 281.422985, size_fine};  // -x
Point(194) = {225.000000, 258.014664, 281.422985, size_fine};  // +y
Point(195) = {225.000000, 191.985336, 281.422985, size_fine};  // -y

// Level 11 (z=289.28, R=38.52)
Point(200) = {225.000000, 225.000000, 289.283619, size_coarse};  // center
Point(202) = {263.517108, 225.000000, 289.283619, size_fine};  // +x
Point(203) = {186.482892, 225.000000, 289.283619, size_fine};  // -x
Point(204) = {225.000000, 263.517108, 289.283619, size_fine};  // +y
Point(205) = {225.000000, 186.482892, 289.283619, size_fine};  // -y

// Level 12 (z=297.14, R=41.66)
Point(210) = {225.000000, 225.000000, 297.144254, size_coarse};  // center
Point(212) = {266.661362, 225.000000, 297.144254, size_fine};  // +x
Point(213) = {183.338638, 225.000000, 297.144254, size_fine};  // -x
Point(214) = {225.000000, 266.661362, 297.144254, size_fine};  // +y
Point(215) = {225.000000, 183.338638, 297.144254, size_fine};  // -y

// Level 13 (z=305.00, R=38.52)
Point(220) = {225.000000, 225.000000, 305.004888, size_coarse};  // center
Point(222) = {263.517108, 225.000000, 305.004888, size_fine};  // +x
Point(223) = {186.482892, 225.000000, 305.004888, size_fine};  // -x
Point(224) = {225.000000, 263.517108, 305.004888, size_fine};  // +y
Point(225) = {225.000000, 186.482892, 305.004888, size_fine};  // -y

// Level 14 (z=312.87, R=33.80)
Point(230) = {225.000000, 225.000000, 312.865522, size_coarse};  // center
Point(232) = {258.800727, 225.000000, 312.865522, size_fine};  // +x
Point(233) = {191.199273, 225.000000, 312.865522, size_fine};  // -x
Point(234) = {225.000000, 258.800727, 312.865522, size_fine};  // +y
Point(235) = {225.000000, 191.199273, 312.865522, size_fine};  // -y

// Level 15 (z=320.73, R=36.94)
Point(240) = {225.000000, 225.000000, 320.726157, size_coarse};  // center
Point(242) = {261.944981, 225.000000, 320.726157, size_fine};  // +x
Point(243) = {188.055019, 225.000000, 320.726157, size_fine};  // -x
Point(244) = {225.000000, 261.944981, 320.726157, size_fine};  // +y
Point(245) = {225.000000, 188.055019, 320.726157, size_fine};  // -y

// Level 16 (z=328.59, R=39.30)
Point(250) = {225.000000, 225.000000, 328.586791, size_coarse};  // center
Point(252) = {264.303171, 225.000000, 328.586791, size_fine};  // +x
Point(253) = {185.696829, 225.000000, 328.586791, size_fine};  // -x
Point(254) = {225.000000, 264.303171, 328.586791, size_fine};  // +y
Point(255) = {225.000000, 185.696829, 328.586791, size_fine};  // -y

// Level 17 (z=336.45, R=35.37)
Point(260) = {225.000000, 225.000000, 336.447425, size_coarse};  // center
Point(262) = {260.372854, 225.000000, 336.447425, size_fine};  // +x
Point(263) = {189.627146, 225.000000, 336.447425, size_fine};  // -x
Point(264) = {225.000000, 260.372854, 336.447425, size_fine};  // +y
Point(265) = {225.000000, 189.627146, 336.447425, size_fine};  // -y

// Level 18 (z=344.31, R=29.87)
Point(270) = {225.000000, 225.000000, 344.308059, size_coarse};  // center
Point(272) = {254.870410, 225.000000, 344.308059, size_fine};  // +x
Point(273) = {195.129590, 225.000000, 344.308059, size_fine};  // -x
Point(274) = {225.000000, 254.870410, 344.308059, size_fine};  // +y
Point(275) = {225.000000, 195.129590, 344.308059, size_fine};  // -y

// Level 19 (z=350.60, R=33.80)
Point(280) = {225.000000, 225.000000, 350.596567, size_coarse};  // center
Point(282) = {258.800727, 225.000000, 350.596567, size_fine};  // +x
Point(283) = {191.199273, 225.000000, 350.596567, size_fine};  // -x
Point(284) = {225.000000, 258.800727, 350.596567, size_fine};  // +y
Point(285) = {225.000000, 191.199273, 350.596567, size_fine};  // -y

// Level 20 (z=357.67, R=36.16)
Point(290) = {225.000000, 225.000000, 357.671138, size_coarse};  // center
Point(292) = {261.158918, 225.000000, 357.671138, size_fine};  // +x
Point(293) = {188.841082, 225.000000, 357.671138, size_fine};  // -x
Point(294) = {225.000000, 261.158918, 357.671138, size_fine};  // +y
Point(295) = {225.000000, 188.841082, 357.671138, size_fine};  // -y

// Level 21 (z=363.17, R=23.58)
Point(300) = {225.000000, 225.000000, 363.173582, size_coarse};  // center
Point(302) = {248.581903, 225.000000, 363.173582, size_fine};  // +x
Point(303) = {201.418097, 225.000000, 363.173582, size_fine};  // -x
Point(304) = {225.000000, 248.581903, 363.173582, size_fine};  // +y
Point(305) = {225.000000, 201.418097, 363.173582, size_fine};  // -y

// Level 22 (z=367.89, R=9.43)
Point(310) = {225.000000, 225.000000, 367.889962, size_coarse};  // center
Point(312) = {234.432761, 225.000000, 367.889962, size_fine};  // +x
Point(313) = {215.567239, 225.000000, 367.889962, size_fine};  // -x
Point(314) = {225.000000, 234.432761, 367.889962, size_fine};  // +y
Point(315) = {225.000000, 215.567239, 367.889962, size_fine};  // -y

// Level 23 - top tip (z=375.75)
Point(320) = {225.000000, 225.000000, 375.750597, size_fine};  // tip
Point(321) = {225.000000, 225.000000, 371.820279, size_coarse};  // center
Point(322) = {228.773104, 225.000000, 371.820279, size_fine};  // +x
Point(323) = {221.226896, 225.000000, 371.820279, size_fine};  // -x
Point(324) = {225.000000, 228.773104, 371.820279, size_fine};  // +y
Point(325) = {225.000000, 221.226896, 371.820279, size_fine};  // -y
