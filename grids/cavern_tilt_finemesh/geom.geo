...
// Geometry parameters (SCALED by 0.706500)
h_bottom = 205.189718;     // bottom elevation of cavern
H_cavern = 141.269881;  // was 200.000 (original), now scaled to 600k m³
R = 35.355082;  // was 50.000 (original), now scaled to 600k m³
