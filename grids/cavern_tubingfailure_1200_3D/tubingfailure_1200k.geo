// ============================================================================
// TUBING FAILURE CAVERN - SCALED TO 1.2 MILLION m³
// ============================================================================
// Based on multichamber structure but with more pronounced neck (smaller R2)
// and slightly larger outer chambers, simulating tubing failure effects
// Target volume:   1.2 Mm³
// Scale factor:    1.004640
//
// Compared to multichamber: R1 48.2 vs 45.6, R2 30.1 vs 39.9, R3 52.2 vs 47.5
// Domain dimensions (Lx, Ly, Lz) remain 450×450×660 m
// ============================================================================

//////////////////////////////////////////////////////////////
// TUBING FAILURE CAVERN - FULL 3D (No Symmetry)
// Three connected spherical chambers with pronounced neck
// SCALED to 1.2M m³ volume
...
h_bottom = 215.471062;  // bottom of cavern
H1 = 64.296947;  // gap between chamber 1 and 2 equators
H2 = 64.296947;  // gap between chamber 2 and 3 equators
R1 = 48.222711;  // bottom chamber radius (multichamber: 45.58)
R2 = 30.139194;  // middle chamber radius (multichamber: 39.88) - smaller = more pronounced neck
R3 = 52.241270;  // top chamber radius (multichamber: 47.48)
