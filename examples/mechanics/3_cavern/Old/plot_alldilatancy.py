...
def plot_pressure_schedule(ax, output_folder):
    ...
    try:
        ...
        ax.text(
            0.5,
            0.5,
            f"Error reading pressure schedule:\n{str(e)}",
            ha="center",
            va="center",
            transform=ax.transAxes,
            fontsize=10,
...
def plot_stress_paths(ax, stress_path: StressPath, i: int, t_step: int, show_legend: bool):
    ...
    # IMPORTANT CHANGE: show_legend controlled from main()
...
def main():
    ...
    for i in range(n_use):
        # IMPORTANT CHANGE: legend only on first stress plot
