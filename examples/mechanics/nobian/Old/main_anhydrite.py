...
def create_input_file():
	...
	ovb_density = 2800
	clay_density = 3000  # Density of the clay layer
	...
	ifa.add_elastic_element(
							name="Spring_0",
							E=[15*GPa, 102*GPa, 68*GPa, 102*GPa],  # E for overburden, salt top, interlayer, salt bottom
							nu=0.32,
							active=True,
							equilibrium=True
	)
	...
	ifa.add_dislocation_creep_element(
							name="disCreep",
							A=[0.0, 1.1e-21, 4.8e-19, 1.1e-21], # A for overburden, salt top, interlayer, salt bottom
							n=[0, 3, 3.9, 3],#n=3.0,
							Q=[0, 51600, 338000, 51600], #Q=51600,
							T=T_profile,
							active=True,
							equilibrium=True
	)
